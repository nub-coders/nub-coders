...
const techLinks: Record<string, TechLink> = {
  ...
  MongoDB: { label: "MongoDB", href: "https://www.mongodb.com/" },
  Redis: { label: "Redis", href: "https://redis.io/" },
  "Drizzle ORM": { label: "Drizzle ORM", href: "https://orm.drizzle.team/" },
  Docker: { label: "Docker", href: "https://www.docker.com/" },
  AWS: { label: "Amazon Web Services", href: "https://aws.amazon.com/" },
...
const getTechLink = (label: string) => techLinks[label] ?? null;

const projects: Project[] = [
  { idx: "001", name: "Deplox", desc: "Application deployment platform with GitHub integration, live updates, cyberpunk terminal UI, and real-time container management to help ship apps faster.", tags: ["TypeScript", "Docker", "Node.js", "React"], liveUrl: "https://deplox.nubcoder.com" },
              ...
              <div className="project-content">
                ...
                <div className="project-tags">
                  {project.tags.map((tag) => {
                    ...
                    if (!techLink) {
                      return <span key={tag} className="project-tag">{tag}</span>;
                    }
