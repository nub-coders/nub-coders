...
const projects: Project[] = [
  { idx: "001", name: "Deplox", desc: "Application deployment platform with GitHub integration, live updates, cyberpunk terminal UI, and real-time container management to help ship apps faster.", tags: ["TypeScript", "Docker", "Node.js", "React"], liveUrl: "https://app.nubcoder.com" },
